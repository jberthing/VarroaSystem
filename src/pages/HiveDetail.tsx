        ...
        <>
              ...
              {[new Date().getFullYear(), new Date().getFullYear() - 1].map((year) => {
                ...
                return (
                  <div key={year} className="yearly-summary-card">
                    <div className="yearly-summary-year">
                      ...
                      {yearlyAvg.isLowSampleCount && (
                        <span
                          ...
                          title={t('hiveDetail.lowSampleWarning', { days: yearlyAvg.sampledDays })}
                        >
                          ⚠️
                        </span>
                      )}
                    ...
                    >
                      {yearlyAvg.averageMitesPerDay.toFixed(1)}{' '}
                      <span className="unit">{t('hiveDetail.mitesPerDay')}</span>
                    </div>
                    <div className="yearly-summary-details">
                      <div className="yearly-summary-detail">
                        <span className="label">{t('hiveDetail.daysUnit')}:</span>
                        <span className="value">{yearlyAvg.sampledDays}</span>
                      </div>
                      <div className="yearly-summary-detail">
          ...
          <div className="observations-section">
                      ...
                      {editingObservation === obs.id ? (
                        <>
                          ...
                          <td>
                            <input
                              ...
                              onChange={(e) =>
                                setEditForm({ ...editForm, miteCount: e.target.value })
                              }
                              min="0"
                              style={{ width: '80px' }}
                            />
                          ...
                          <td>
                            <input
                              ...
                              onChange={(e) =>
                                setEditForm({ ...editForm, trayDays: e.target.value })
                              }
                              min="1"
                              style={{ width: '60px' }}
                            />
                          ...
                          <td>
                            ...
                            <button onClick={handleCancelEdit} className="secondary small">
                              {t('hiveDetail.cancel')}
                            </button>
                          </td>
                        </>
                        ...
                        <>
                          ...
                          <td>
                            ...
                            <button onClick={() => handleDelete(obs.id)} className="danger small">
                              {t('hiveDetail.delete')}
                            </button>
                          </td>
                        </>
            ...
            {observations.length > 10 && (
              <p className="showing-info">Viser de seneste 10 af {observations.length} målinger</p>
            )}
          </div>
